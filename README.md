...
MIT License
Проект распространяется под лицензией, разрешающей свободное использование с обязательным указанием авторства. Полный текст лицензии доступен в файле LICENSE.
...
⭐ Поддержка
Если deribit_price_collector помог вам в работе или обучении, пожалуйста:

Поставьте звезду на GitHub — это лучшая благодарность!
Расскажите о проекте коллегам
Создавайте issue с предложениями по улучшению
